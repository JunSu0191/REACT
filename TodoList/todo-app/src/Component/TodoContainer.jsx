...
const TodoContainer = () => {
  ...
  const onallDelete = async () => {
    ...
    setTodoList([]); // 클라이언트 상태에서도 전체 목록을 비워줍니다.
  }

  return (
    <div className='container'>
      <TodoHeader />
      <TodoInput onSubmit={onSubmit} onChange={onChange} input={input} />
      <TodoList todoList={todoList} onToggle={onToggle} onRemove={onRemove}/>
      <TodoFooter onallDelete={onallDelete} onCompleteAll={onCompleteAll}/>
    </div>
  )
}
